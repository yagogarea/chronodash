...
defmodule Chronodash.DataCase do
  @moduledoc """
  ...
  by setting `use Chronodash.DataCase, async: true`, although
  ...
  using do
    quote do
      alias Chronodash.Repo

      import Ecto
      import Ecto.Changeset
      import Ecto.Query
      import Chronodash.DataCase
    end
  end
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(Chronodash.Repo, shared: not tags[:async])
